...
def app():
    st.title('Bar Chart Maker (Data Comparison for Female)')
    file = st.file_uploader("Chose a file")
    if file is not None:
        df = pd.read_excel(file)
        st.dataframe(round(df, 2))
        st.sidebar.header('Fitness Test Comparison')
        ...
        def load_data(y):
            if y == 'NAME':
            ...
            elif y == 'BMI_1' or y == 'BMI_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['BMI_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_BMI = 18.5
                b_BMI = 18.5
                b1_BMI = 24.9
                ...
                yy = st.sidebar.slider("upper Y-axis", 0., 100., 30.)
                ...
                y1 = round(df['BMI_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val < a_BMI:
                        ...
                        cc[n] = 'darkgoldenrod'
                ax = plt.bar(x_axis + 0.2, y1, color=cc, width=0.25)
                for i in range(len(x)):
                    plt.text(i + 0.25, y1[i], y1[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
            ...
            elif y == 'BODY FAT_1' or y == 'BODY FAT_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['BODY FAT_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_BF = 30
                b_BF = 29
                for n, val in enumerate(y):
                ...
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y2 = round(df['BODY FAT_2'].astype(float), 2)
                cc = ['colors'] * len(y2)
                for n, val in enumerate(y2):
                    if val < a_BF:
                        cc[n] = 'green'
                    else:
                        cc[n] = 'yellow'
                ax = plt.bar(x_axis + 0.2, y2, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i + 0.25, y2[i], y2[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                plt.xticks(x_axis, x, rotation='vertical', fontsize="medium", ha="right", va="center", wrap=True)
                plt.title("Body Fat")
                plt.ylabel("Body Fat (%)")
                plt.ylim(xx, yy)
            ...
            elif y == 'MAXIMUM PUSH UP_1' or y == 'MAXIMUM PUSH UP_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['MAXIMUM PUSH UP_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_MPU = 1
                b_MPU = 2
                b1_MPU = 3
                ...
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['MAXIMUM PUSH UP_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val < a_MPU:
                        cc[n] = 'green'
                        ...
                        cc[n] = 'darkgoldenrod'
                ax = plt.bar(x_axis + 0.2, y1, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i + 0.25, y1[i], y1[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                plt.xticks(x_axis, x, rotation='vertical', fontsize="medium", ha="right", va="center", wrap=True)
            ...
            elif y == '1 MIN SIT UP_1' or y == "1 MIN SIT UP_2":
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['1 MIN SIT UP_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_MSU = 1
                b_MSU = 2
                b1_MSU = 3
                ...
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['1 MIN SIT UP_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val < 10:
                        cc[n] = 'green'
            ...
            elif y == 'SBJ_1' or y == 'SBJ_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['SBJ_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_SBJ = 150
                b_SBJ = 150
                b1_SBJ = 166
                ...
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['SBJ_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val < a_SBJ:
                        cc[n] = 'green'
            ...
            elif y == 'CMJ_1' or y == 'CMJ_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['CMJ_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_CMJ = 28.5
                b_CMJ = 28.5
                b1_CMJ = 33.9
                ...
                yy = st.sidebar.slider("upper Y-axis", 0., 120., 90.)
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['CMJ_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val < a_CMJ:
                        cc[n] = 'green'
            ...
            elif y == 'ILLINOIS/L_1' or y == 'ILLINOIS/L_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                ...
                width = st.sidebar.slider("plot width", 1., 15., 10.)
                height = st.sidebar.slider("plot height", 1., 10., 5.)
                xx = st.sidebar.slider("bottom Y-axis", 0., 30., 0.)
                yy = st.sidebar.slider("upper Y-axis", 0., 40., 15.)
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.3, y[i], y[i], ha="left", va="bottom", fontsize="medium", rotation='vertical')
                y1 = round(df['ILLINOIS/L_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val > a_AT:
                        cc[n] = 'green'
                        ...
                        cc[n] = 'red'
                ax = plt.bar(x_axis + 0.2, y1, width=0.2, color=cc)
                for i in range(len(x)):
                    plt.text(i + 0.3, y1[i], y1[i], ha="right", va="bottom", fontsize="medium", rotation='vertical')
                plt.xticks(x_axis, x, rotation='vertical', fontsize="medium", ha="right", va="center", wrap=True)
                plt.title("Illinois Agility Test (Left)")
                plt.ylabel("Time (s)")
                plt.ylim(xx, yy)
            ...
            elif y == 'ILLINOIS/R_1' or y == 'ILLINOIS/R_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['ILLINOIS/R_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_AT = 23.0
                b_AT = 23.0
                b1_AT = 21.8
                ...
                for i in range(len(x)):
                    plt.text(i - 0.3, y[i], y[i], ha="left", va="bottom", fontsize="medium", rotation='vertical')
                y1 = round(df['ILLINOIS/R_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val > a_AT:
                        cc[n] = 'green'
                ...
                for i in range(len(x)):
                    plt.text(i + 0.3, y1[i], y1[i], ha="right", va="bottom", fontsize="medium", rotation='vertical')
                plt.xticks(x_axis, x, rotation='vertical', fontsize="medium", ha="right", va="center", wrap=True)
                plt.title("Illinois Agility Test (Right)")
                plt.ylabel("Time (s)")
                plt.ylim(xx, yy)
                A1 = mpatches.Patch(color='green', label='Below Average > (' + str(a_AT) + ')')
                A2 = mpatches.Patch(color='lime', label='Average (' + str(b_AT) + '-' + str(b1_AT) + ')')
            ...
            elif y == 'SIT & REACH_1' or y == 'SIT & REACH_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                ...
                width = st.sidebar.slider("plot width", 1., 15., 10.)
                height = st.sidebar.slider("plot height", 1., 10., 5.)
                xx = st.sidebar.slider("bottom Y-axis", 0., 80., 0.)
                yy = st.sidebar.slider("upper Y-axis", 0., 80., 50.)
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
            ...
            elif y == '10 M SPRINT_1' or y == '10 M SPRINT_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                ...
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['10 M SPRINT_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val > a_10M:
                        cc[n] = 'green'
            ...
            elif y == '20 M SPRINT_1' or y == '20 M SPRINT_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                ...
                width = st.sidebar.slider("plot width", 1., 15., 10.)
                height = st.sidebar.slider("plot height", 1., 10., 5.)
                xx = st.sidebar.slider("bottom Y-axis", 0., 7., 0.)
                yy = st.sidebar.slider("upper Y-axis", 0., 7., 4.)
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['20 M SPRINT_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val > a_20M:
                        cc[n] = 'green'
            ...
            elif y == '40 M SPRINT_1' or y == '40 M SPRINT_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                y = round(df['40 M SPRINT_1'].astype(float), 2)
                cc = ['colors'] * len(y)
                a_40M = 3.5
                b_40M = 3.28
                b1_40M = 3.5
                ...
                width = st.sidebar.slider("plot width", 1., 15., 10.)
                height = st.sidebar.slider("plot height", 1., 10., 5.)
                xx = st.sidebar.slider("bottom Y-axis", 0., 10., 0.)
                yy = st.sidebar.slider("upper Y-axis", 0., 10., 7.)
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['40 M SPRINT_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val > a_40M:
                        cc[n] = 'green'
                ...
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
                y1 = round(df['TOTAL_2'].astype(float), 2)
                cc = ['colors'] * len(y1)
                for n, val in enumerate(y1):
                    if val < a_HG:
                        cc[n] = 'green'
            ...
            elif y == 'YOYO TEST_1' or y == 'YOYO TEST_2':
                x = df['NAME']
                x_axis = np.arange(len(x))
                ...
                yy = st.sidebar.slider("upper Y-axis", 0., 20., 13.)
                fig, ax = plt.subplots(figsize=(width, height))
                ax = plt.bar(x_axis - 0.2, y, color=cc, width=0.2)
                for i in range(len(x)):
                    plt.text(i - 0.25, y[i], y[i], ha="center", va="bottom", fontsize="medium", rotation="vertical")
