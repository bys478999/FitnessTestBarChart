    ...
    if choice == "Home":
       ...
       if st.sidebar.checkbox("Login"): 
            if password == "1234" and username == "abu":
                   ...
                   ax[0,0].pie(y, labels=y)
                   ax[0,1].pie(y1,labels=y1)
                   ax[0,2].pie(y2,labels=y2)
                   ax[1,0].legend(mylabels, loc='best')
                   ax[1,1].legend(mylabels1, loc='best')
                   ax[1,2].legend(mylabels2, loc='best')
