       ...
       if st.sidebar.checkbox("Login"): 
          ...
          if st.sidebar.checkbox("Login"): 
               if password == st.secrets["password"]:
                    ...
                    col1, col2 = st.columns(2)
                    startdate = col1.date_input("Chose the start date(year/month/day):",datetime.date(2019, 7, 6))
                    enddate = col2.date_input("Chose the end date(year/month/day):",datetime.date(2019, 7, 6))
